<CsoundSynthesizer>
<CsOptions>
-W -o ej5.7.wav  ; salida a este fichero WAV
</CsOptions>
<CsInstruments>
...
instr senovar
  ...
  iFrec  = p5  ; se recibe altura y se convierte en Hz
  ipi    = $M_PI       ; macro que contiene el valor de pi
  
  kFrec line iFrec, p3, 660
  
  kn timek
  
  if kn==sr then
  		printks "Frecuencia: %d Hz\n", 0, kFrec
  endif
