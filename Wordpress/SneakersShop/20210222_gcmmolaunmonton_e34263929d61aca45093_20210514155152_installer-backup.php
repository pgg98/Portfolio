...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210222_gcmmolaunmonton_e34263929d61aca45093_20210514155152_archive.zip';
	const ARCHIVE_SIZE		 = '73720200';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'e342639-14155152';
    const SECONDARY_PACKAGE_HASH = '82d0ac6-14155152';
	const VERSION			 = '1.4.0';
