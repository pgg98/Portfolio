...
namespace UnicarAdmin
{
    ...
    /// </summary>
    public partial class Climatologíasdiarias : IServiceOperations<AEMETOpenData>, IClimatologíasdiarias
    {
        /// <summary>
        /// Initializes a new instance of the Climatologíasdiarias class.
        /// </summary>
        /// <param name='client'>
        /// Reference to the service client.
        /// </param>
        public Climatologíasdiarias(AEMETOpenData client)
        {
            if (client == null) 
            {
        ...
        /// </return>
        public async Task<HttpOperationResponse<object>> OneWithHttpMessagesAsync(string fechaIniStr, string fechaFinStr, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (fechaIniStr == null)
            {
            ...
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "api/valores/climatologicos/diarios/datos/fechaini/{fechaIniStr}/fechafin/{fechaFinStr}/todasestaciones").ToString();
