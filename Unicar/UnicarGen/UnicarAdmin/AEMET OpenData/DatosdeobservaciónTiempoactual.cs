...
namespace UnicarAdmin
{
    ...
    /// </summary>
    public partial class DatosdeobservaciónTiempoactual : IServiceOperations<AEMETOpenData>, IDatosdeobservaciónTiempoactual
    {
        /// <summary>
        /// Initializes a new instance of the DatosdeobservaciónTiempoactual class.
        /// </summary>
        /// <param name='client'>
        /// Reference to the service client.
        /// </param>
        public DatosdeobservaciónTiempoactual(AEMETOpenData client)
        {
            if (client == null) 
            {
        ...
        /// </return>
        public async Task<HttpOperationResponse<object>> OneWithHttpMessagesAsync(string idema, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (idema == null)
            {
            ...
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "api/observacion/convencional/datos/estacion/{idema}").ToString();
