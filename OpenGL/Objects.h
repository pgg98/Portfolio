...
public: // Atributos de la clase
        ...
        //Atributos para movimiento con raton
        bool movido; //la pongo a true en motion
        int last_x, last_y; //la anterior posicion del raton y luego podias saber cual es la direccion realmente
        TOperacion operacion; //operacion seleccionada en raton
        bool activo_z; //cntrl pulsado
        GLfloat rot_x, rot_y, rot_z; //acumula las rotaciones provocadas por el raton.
