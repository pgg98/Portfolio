...
TPrimitiva::TPrimitiva(int DL, int t)
{
	...
	switch (tipo) {
		case CARRETERA_ID: {  // Creación de la carretera
            ...
            modelo0 = Load3DS("../../Modelos/Road.3ds", &num_vertices0); //Para cada objeto carga dos modelos.
		...
		case MI_FIGURITA:{
            ...
            modelo0 = Load3DS("../../Modelos/mio.3ds", &num_vertices0);
            break;
            //siendo "mio.3ds" mi modelado.
		}
	} // switch
}
...
void __fastcall TEscena::Render()
{
    ...
    //para rotar hay TODO. 3 variables donde hay que ir almacenando lo que le pase a la escena.
