...
void __fastcall TEscena::Render()
{
    ...
    // añadir dos vectores v mas, para cada intensidad de luz.
...
void __fastcall TGui::Init(int main_window) {
    ...
    GLUI_Panel *panelProyeccion = new GLUI_Panel(obj_panel, "Proyección");
    ...
    GLUI_Panel *panelCamara = new GLUI_Panel(obj_panel, "CÁMARA");
    ...
    glui->add_radiobutton_to_group(radioGroupCamara, "Aérea");
    glui->add_radiobutton_to_group(radioGroupCamara, "3ª persona");

    /***** Control para las propiedades de escena *****/
    GLUI_Panel *panelModo = new GLUI_Panel(obj_panel, "Modo visualización");
    ...
    glui->add_radiobutton_to_group(radioGroupModo, "Alámbrico");
