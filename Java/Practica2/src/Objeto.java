...
public class Objeto{
    ...
    public void influenciaPositiva(){
        influencia=influencia*(-1);
    }

    public void sumarInfluencia(int num){
        influencia=influencia+num;
    }

    public void restarInfluencia(int num){
        influencia=influencia-num;
    }



    public void multiplicaInfluencia(int num){
        influencia=influencia*num;
    }
}